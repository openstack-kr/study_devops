...
echo "[CALL scripts/kilo-6.1.3.2-6.controller.sh]=========================================="
ssh root@10.0.0.11 "cd ~student/scripts/; ~student/scripts/kilo-6.1.3.2-6.controller.sh"
# (7) Verify operation
echo "[CALL scripts/scripts/kilo-6.1.3.7.controller.sh]=========================================="
...
echo "[CALL scripts/kilo-6.1.4.1_8-1.network.sh]=========================================="
...
echo "[CALL scripts/kilo-6.1.4.8-2_8-3.controller.sh]=========================================="
...
echo "[CALL scripts/kilo-6.1.4.9_10.network.sh]=========================================="
...
# (11) Verify operation
echo "[CALL scripts/kilo-6.1.4.11.controller.sh]=========================================="
...
echo "[CALL scripts/kilo-6.1.5.1_8.compute.sh]=========================================="
ssh root@10.0.0.31 "cd ~student/scripts/; ~student/scripts/kilo-6.1.5.1_8.compute.sh"

# (9) Verify operation
echo "[CALL scripts/kilo-6.1.5.9.controller.sh]=========================================="
